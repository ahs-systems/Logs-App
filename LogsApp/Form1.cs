    ...
    public partial class Form1 : Form
    {
        ...
        private void btnTimer_Click(object sender, EventArgs e)
        {
            if (!toggleStopWatch) 
            {
                ...
                stopWatch.Reset();
                stopWatch.Start();
                dateTimePicker1.Enabled = comboBox1.Enabled = comboBox2.Enabled = txtComments.Enabled = txtMins.Enabled = button1.Enabled = button2.Enabled = btnExportToExcel.Enabled = false;
                timer1.Enabled = true;
            }
            else
            {
                ...
                dateTimePicker1.Enabled = comboBox1.Enabled = comboBox2.Enabled = txtComments.Enabled = txtMins.Enabled = button1.Enabled = button2.Enabled = btnExportToExcel.Enabled = true;
            }
